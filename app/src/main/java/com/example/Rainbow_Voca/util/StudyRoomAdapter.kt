...
import com.example.Rainbow_Voca.model.StudyRoom // StudyRoom 모델 import
...
class StudyRoomAdapter(
    ...
    inner class StudyRoomViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(room: StudyRoom) { // StudyRoom 객체로 바인딩
            ...
            memberCountTextView.text = "인원: ${room.getCurrentMemberCount()}" // StudyRoom의 getCurrentMemberCount() 사용
